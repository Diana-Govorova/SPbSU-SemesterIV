...
# Функция получения всех событий для marathon.bet на киберспорт
...
# Функция получения всех событий для tennisi на киберспорт
...
# Основная функция
def main():
    url_marathonbet = 'https://www.marathonbet.ru/su/betting/e-Sports+-+1895085?interval=ALL_TIME'
    ...
    url_tennisi = 'https://tennisi.bet/rt/cgi/!rt_home.CategoryInfo?mcmd=5&gameid=5&categoryid=439908280&lang=rus&more=today&lang=rus'
