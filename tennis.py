...
# Функция получения всех событий для marathon.bet на теннис
...
# Функция получения всех событий для tennisi на теннис
def get_all_event_tennisi(html):
    ...
    for event in all_event:
        ...
        if '(' in players or ' - ' not in players:
            continue
...
# Основная функция
def main():
    url_marathonbet = 'https://www.marathonbet.ru/su/betting/Tennis+-+2398?interval=ALL_TIME'
    ...
    url_tennisi = 'https://tennisi.bet/rt/cgi/!rt_home.CategoryInfo?gameid=5&categoryid=139&more=today&lang=rus'
