...
# Функция получения всех событий для marathon.bet на футбол
...
# Функция получения всех событий для tennisi на футбол
...
# Основная функция
def main():
    url_marathonbet = 'https://www.marathonbet.ru/su/betting/American+Football+-+4?interval=ALL_TIME'
    ...
    url_tennisi = 'https://tennisi.bet/rt/cgi/!rt_home.CategoryInfo?mcmd=5&gameid=5&categoryid=4076387&lang=rus&more=today&lang=rus'
