...
# Функция получения всех событий для marathon.bet на волейбол
...
# Функция получения всех событий для tennisi на волейбол
...
# Основная функция
def main():
    url_marathonbet = 'https://www.marathonbet.ru/su/betting/Volleyball+-+22712?interval=ALL_TIME'
    ...
    url_tennisi = 'https://tennisi.bet/rt/cgi/!rt_home.CategoryInfo?mcmd=5&gameid=5&categoryid=9027116&lang=rus&more=today&lang=rus'
