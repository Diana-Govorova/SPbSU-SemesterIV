...
# Функция получения всех событий для marathon.bet на бейсбол
...
# Функция получения всех событий для tennisi на бейсбол
...
# Основная функция
def main():
    url_marathonbet = 'https://www.marathonbet.ru/su/betting/Baseball+-+5?interval=ALL_TIME'
    ...
    url_tennisi = 'https://tennisi.bet/rt/cgi/!rt_home.CategoryInfo?mcmd=5&gameid=5&categoryid=326835&lang=rus&more=today&lang=rus'
